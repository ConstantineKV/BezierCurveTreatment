...
public:
	...
	*/
	...
	t - argument
	*/
	double polinome(int i, int n, double t);
	/*
...
public:
	...
	bool CheckBody(string body, string argument, unsigned int number_of_points);
	...
	*/
	...
	string NameFromDescription(string Description, unsigned int& position);
	...
	string ArgumentFromDescription(string Description, unsigned int& position);
	...
	string BodyFromDescription(string Description, unsigned int& position);
	...
	int NumberOfPointsFromDescription(string Description);
